...
$images = json_decode($imagesJson);
  ...
  $sql = "INSERT INTO cars(a_id,make,model,trim,regional_specs_ar,regional_specs_en,year,kilometers,price,number,fuel_type_ar,fuel_type_en,body_condition_ar,body_condition_en,mech_condition_ar,mech_condition_en,exterior_color_ar,exterior_color_en,interior_color_ar,interior_color_en,doors_ar,doors_en,no_of_cylinder_ar,no_of_cylinder_en,transmission_type_ar,transmission_type_en,body_type_ar,body_type_en,horsepower_ar,horsepower_en,steering_side_ar,steering_side_en,extras_ar,extras_en,image,date)VALUES('$a_id','$make','$model','$trim','$regional_specs_ar','$regional_specs_en','$year','$kilometers','$price','$number','$fuel_type_ar','$fuel_type_en','$body_condition_ar','$body_condition_en','$mech_condition_ar','$mech_condition_en','$exterior_color_ar','$exterior_color_en','$interior_color_ar','$interior_color_en','$doors_ar','$doors_en','$no_of_cylinder_ar','$no_of_cylinder_en','$transmission_type_ar','$transmission_type_en','$body_type_ar','$body_type_en','$horsepower_ar','$horsepower_en','$steering_side_ar','$steering_side_en','$extras_ar','$extras_en','$json','$date')";
