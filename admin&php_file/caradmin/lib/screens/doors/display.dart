...
class DoorsDisplay extends StatefulWidget {

  @override
  State<DoorsDisplay> createState() => _DoorsDisplayState();
}

class _DoorsDisplayState extends State<DoorsDisplay> {

  Future Display() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/doors/read.php');
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => DoorsEdit(list: list,index: index,),),);
                                                },
                                                child: Icon(
                                                  Icons.edit,
                                                  color: Colors.black,
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        actions: <Widget>[
                                                          ...
                                                          ElevatedButton(
                                                              onPressed: (){
                                                                setState(() {
                                                                  var url = Uri.parse('http://10.0.2.2/carshow/admin/doors/delete.php');
                                                                  http.post(url,body: {
                                                                    'id' : list[index]['id'],
                                                                  });
                                                                  Navigator.of(context).pop();
