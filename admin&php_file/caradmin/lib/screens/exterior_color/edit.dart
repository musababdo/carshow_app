...
class ExteriorEdit extends StatefulWidget {
  final List list;
  final int index;
  ExteriorEdit({required this.list,required this.index});

  @override
  State<ExteriorEdit> createState() => _ExteriorEditState();
}

class _ExteriorEditState extends State<ExteriorEdit> {
  ...
  String? id;
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/exterior_color/edit.php');
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          hintText: "اللون الخادجي بالعربي"
                      ),
                    ),
                    SizedBox(height: 15,),
                    TextFormField(
