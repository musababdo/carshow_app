...
class ExteriorDisplay extends StatefulWidget {

  @override
  State<ExteriorDisplay> createState() => _ExteriorDisplayState();
}

class _ExteriorDisplayState extends State<ExteriorDisplay> {

  Future Display() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/exterior_color/read.php');
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => ExteriorEdit(list: list,index: index,),),);
                                                },
                                                child: Icon(
                                                  Icons.edit,
                                                  color: Colors.black,
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        actions: <Widget>[
                                                          ...
                                                          ElevatedButton(
                                                              onPressed: (){
                                                                setState(() {
                                                                  var url = Uri.parse('http://10.0.2.2/carshow/admin/exterior_color/delete.php');
                                                                  http.post(url,body: {
                                                                    'id' : list[index]['id'],
                                                                  });
                                                                  Navigator.of(context).pop();
