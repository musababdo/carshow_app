...
import 'package:caradmin/screens/steering_side/add.dart';
import 'package:caradmin/screens/steering_side/edit.dart';
...
class _SteeringDisplayState extends State<SteeringDisplay> {
  ...
  Future Display() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/steering_side/read.php');
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => SteeringEdit(list: list,index: index,),),);
                                                },
                                                child: Icon(
                                                  Icons.edit,
                                                  color: Colors.black,
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        actions: <Widget>[
                                                          ...
                                                          ElevatedButton(
                                                              onPressed: (){
                                                                setState(() {
                                                                  var url = Uri.parse('http://10.0.2.2/carshow/admin/steering_side/delete.php');
                                                                  http.post(url,body: {
                                                                    'id' : list[index]['id'],
                                                                  });
                                                                  Navigator.of(context).pop();
