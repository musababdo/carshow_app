...
class InteriorAdd extends StatefulWidget {

  @override
  State<InteriorAdd> createState() => _InteriorAddState();
}

class _InteriorAddState extends State<InteriorAdd> {
  ...
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/interior_color/add.php');
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          hintStyle: TextStyle(color: Colors.blue),
                          hintText: "اللون الداخلي بالانجليزي"
                      ),
                    ),
                    SizedBox(height: 15,),
                    Builder(
