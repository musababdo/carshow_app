...
class FuelTypeDisplay extends StatefulWidget {

  @override
  State<FuelTypeDisplay> createState() => _FuelTypeDisplayState();
}

class _FuelTypeDisplayState extends State<FuelTypeDisplay> {

  Future Display() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/fuel_type/read.php');
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => FuelTypeEdit(list: list,index: index,),),);
                                                },
                                                child: Icon(
                                                  Icons.edit,
                                                  color: Colors.black,
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        actions: <Widget>[
                                                          ...
                                                          ElevatedButton(
                                                              onPressed: (){
                                                                setState(() {
                                                                  var url = Uri.parse('http://10.0.2.2/carshow/admin/fuel_type/delete.php');
                                                                  http.post(url,body: {
                                                                    'id' : list[index]['id'],
                                                                  });
                                                                  Navigator.of(context).pop();
