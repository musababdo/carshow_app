...
class FuelTypeAdd extends StatefulWidget {

  @override
  State<FuelTypeAdd> createState() => _FuelTypeAddState();
}

class _FuelTypeAddState extends State<FuelTypeAdd> {
  ...
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/fuel_type/add.php');
