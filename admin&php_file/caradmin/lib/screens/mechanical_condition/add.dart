...
class MechaCondAdd extends StatefulWidget {

  @override
  State<MechaCondAdd> createState() => _MechaCondAddState();
}

class _MechaCondAddState extends State<MechaCondAdd> {
  ...
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/mechanical_condition/add.php');
