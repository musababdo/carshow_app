...
class TransmissionEdit extends StatefulWidget {
  final List list;
  final int index;
  TransmissionEdit({required this.list,required this.index});

  @override
  State<TransmissionEdit> createState() => _TransmissionEditState();
}

class _TransmissionEditState extends State<TransmissionEdit> {
  ...
  String? id;
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/transmission_type/edit.php');
  ...
  String? _errorMessage(String hint) {
    if(hint=="نوع النقل بالعربي"){
      return 'هذا الحقل مطلوب';
    }else if(hint=="نوع النقل بالانجليزي"){
      return 'هذا الحقل مطلوب';
    }
  }
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      validator:(value) {
                        if (value!.isEmpty) {
                          return _errorMessage("نوع النقل بالعربي");
                    ...
                    TextFormField(
                      validator:(value) {
                        if (value!.isEmpty) {
                          return _errorMessage("نوع النقل بالانجليزي");
                          // ignore: missing_return
                        }
                      },
                      controller: name_en,
