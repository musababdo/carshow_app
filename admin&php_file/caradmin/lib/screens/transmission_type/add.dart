...
class TransmissionAdd extends StatefulWidget {

  @override
  State<TransmissionAdd> createState() => _TransmissionAddState();
}

class _TransmissionAddState extends State<TransmissionAdd> {
  ...
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/transmission_type/add.php');
