...
import 'package:caradmin/screens/admin/add.dart';
import 'package:caradmin/screens/admin/edit.dart';
...
class _adminDisplayState extends State<adminDisplay> {
  ...
  Future Display() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/admin/read.php');
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => adminEdit(list: list,index: index,),),);
                                                },
                                                child: Icon(
                                                  Icons.edit,
                                                  color: Colors.black,
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        actions: <Widget>[
                                                          ...
                                                          ElevatedButton(
                                                              onPressed: (){
                                                                setState(() {
                                                                  var url = Uri.parse('http://10.0.2.2/carshow/admin/admin/delete.php');
                                                                  http.post(url,body: {
                                                                    'id' : list[index]['id'],
                                                                  });
                                                                  Navigator.of(context).pop();
