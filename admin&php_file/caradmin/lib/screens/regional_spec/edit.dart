...
class RegionalEdit extends StatefulWidget {
  final List list;
  final int index;
  RegionalEdit({required this.list,required this.index});

  @override
  State<RegionalEdit> createState() => _RegionalEditState();
}

class _RegionalEditState extends State<RegionalEdit> {
  ...
  String? id;
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/regional_specs/edit.php');
