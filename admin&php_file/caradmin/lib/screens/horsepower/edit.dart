...
class HorseEdit extends StatefulWidget {
  final List list;
  final int index;
  HorseEdit({required this.list,required this.index});

  @override
  State<HorseEdit> createState() => _HorseEditState();
}

class _HorseEditState extends State<HorseEdit> {
  ...
  String? id;
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/horsepower/edit.php');
