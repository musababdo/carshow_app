...
class BodyTypeAdd extends StatefulWidget {

  @override
  State<BodyTypeAdd> createState() => _BodyTypeAddState();
}

class _BodyTypeAddState extends State<BodyTypeAdd> {
  ...
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/body_type/add.php');
