...
class BodyTypeEdit extends StatefulWidget {
  final List list;
  final int index;
  BodyTypeEdit({required this.list,required this.index});

  @override
  State<BodyTypeEdit> createState() => _BodyTypeEditState();
}

class _BodyTypeEditState extends State<BodyTypeEdit> {
  ...
  String? id;
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/body_type/edit.php');
  ...
  String? _errorMessage(String hint) {
    if(hint=="نوع الجسم بالعربي"){
      return 'هذا الحقل مطلوب';
    }else if(hint=="نوع الجسم بالانجليزي"){
      return 'هذا الحقل مطلوب';
    }
  }
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      validator:(value) {
                        if (value!.isEmpty) {
                          return _errorMessage("نوع الجسم بالعربي");
                    ...
                    TextFormField(
                      validator:(value) {
                        if (value!.isEmpty) {
                          return _errorMessage("نوع الجسم بالانجليزي");
                          // ignore: missing_return
                        }
                      },
                      controller: name_en,
