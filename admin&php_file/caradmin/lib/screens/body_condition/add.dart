...
class BodyCondAdd extends StatefulWidget {

  @override
  State<BodyCondAdd> createState() => _BodyCondAddState();
}

class _BodyCondAddState extends State<BodyCondAdd> {
  ...
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/body_condition/add.php');
