...
import 'package:caradmin/screens/no_of_cylinders/add.dart';
import 'package:caradmin/screens/no_of_cylinders/edit.dart';
...
class NoOfDisplay extends StatefulWidget {

  @override
  State<NoOfDisplay> createState() => _NoOfDisplayState();
}

class _NoOfDisplayState extends State<NoOfDisplay> {

  Future Display() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/no_of_cylinders/read.php');
                                          ...
                                          children: <Widget>[
                                            Padding(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => NoOfEdit(list: list,index: index,),),);
                                                },
                                                child: Icon(
                                                  Icons.edit,
                                                  color: Colors.black,
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        actions: <Widget>[
                                                          ...
                                                          ElevatedButton(
                                                              onPressed: (){
                                                                setState(() {
                                                                  var url = Uri.parse('http://10.0.2.2/carshow/admin/no_of_cylinders/delete.php');
                                                                  http.post(url,body: {
                                                                    'id' : list[index]['id'],
                                                                  });
                                                                  Navigator.of(context).pop();
