...
class NoOfAdd extends StatefulWidget {

  @override
  State<NoOfAdd> createState() => _NoOfAddState();
}

class _NoOfAddState extends State<NoOfAdd> {
  ...
  Future save() async{
    var url = Uri.parse('http://10.0.2.2/carshow/admin/no_of_cylinders/add.php');
