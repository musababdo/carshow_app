...
class _AddThreeState extends State<AddThree> {
  ...
  String? make,model,trim,regional_ar,regional_en,fuel_ar,fuel_en,body_cond_ar,body_cond_en;
  ...
  String? a_id;
  Future save() async{
      final uri = Uri.parse('http://10.0.2.2/carshow/car_add.php');
  ...
  Future uploadImage() async {
    ...
    var url = Uri.parse('http://10.0.2.2/carshow/car_add.php');
